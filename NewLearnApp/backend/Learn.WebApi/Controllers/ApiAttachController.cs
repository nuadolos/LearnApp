...
namespace LearnApp.WebApi.Controllers
{
    ...
    public class ApiAttachController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet("Get/{id}")]
        public async Task<ActionResult<LearnDocuments>> GetAttachAsync([FromRoute] int id)
        {
        ...
        public async Task<ActionResult<LearnDocuments>> GetAttachAsync([FromRoute] string email, [FromRoute] int learnId)
        {
